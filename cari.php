...
require("config.php");
$perintah = "SELECT * FROM produk_kami WHERE (judul like '%$cari%')or(isi like '%$cari%')  ORDER BY id DESC";
$hasil = mysql_query($perintah);
if (mysql_num_rows($hasil) > 0) {
echo ("<font face=\"arial\" size=\"2\"><center><p>Ditemukan artikel yang mengandung kata kunci <b>$katakunci</b>:</center></font>
<ul>
");
while($data=mysql_fetch_array($hasil)) {
echo ("
<li><b><a style=\"color: blue\" href=\"isi_detail.php?id=$data[id]\"><font face=\"arial\" size=\"2\">$data[judul]</b></font></a></li>
");
}
echo("</ul>");
} else {
echo("<font face=\"arial\" size=\"2\"><center>Maaf, artikel dengan kata kunci <b>$katakunci</b> tidak ditemukan.</center></font>");
}
?></td>
  </tr>
  <tr>
